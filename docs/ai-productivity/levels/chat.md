...
**[Continue to Level 2: Context →](/docs/ai-productivity/levels/context)**
...
|---------------|------------------|
| Describe your code verbally | Paste actual code |
| "I have a React component that..." | [paste component code] |
| AI guesses at details | AI sees the real situation |
| Generic advice | Specific guidance |
