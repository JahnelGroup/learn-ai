...
Review the [AI Periodic Table](/docs/periodic-table) and honestly assess where you are today.
...
**[Explore Foundation Tier →](/docs/tiers/foundation)**
...
Use the [portfolio templates](/docs/portfolio-templates/foundation-use-case) to structure your documentation. They're designed to capture the learning, not just the outcome.
...
|----------|-------------|
| [AI Periodic Table](/docs/periodic-table) | The full mental model with all 20 elements |
| [Foundation Tier](/docs/tiers/foundation) | Start here—core concepts and vocabulary |
| [Practitioner Tier](/docs/tiers/practitioner) | Build and deploy AI features |
| [Expert Tier](/docs/tiers/expert) | Architect systems and lead others |
| [Portfolio Templates](/docs/portfolio-templates/foundation-use-case) | Document your learning |
