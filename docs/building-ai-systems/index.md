...
Review the [AI Periodic Table](/docs/building-ai-systems/periodic-table/) and honestly assess where you are today.
...
**[Explore Foundation Tier →](/docs/building-ai-systems/tiers/foundation)**
...
- **Ask questions of those ahead of you**, as they were in your position recently
...
|----------|-------------|
| [AI Periodic Table](/docs/building-ai-systems/periodic-table/) | The full mental model with all 20 elements |
